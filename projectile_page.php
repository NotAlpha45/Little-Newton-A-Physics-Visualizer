...
if ($param0val) {
    ...
    $sql = "INSERT INTO problem (user_id, problem_name, param1, param2, param3, param4) VALUES ($u_id,'projectile_page.php', $param1val, $param2val, $param3val, $param4val)";
