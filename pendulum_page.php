            ...
            <div class="mathcontainer" id="math">
                ...
                <div class="description" id="description">
                    <p>A simple pendulum has an
                        ...
                        <customTag class="effectiveLength"><?=$param2?> <customTag class="unit">m</customTag>
                        </customTag>
                        and was set in motion at an
                        <customTag class="angle">angle</customTag> of <customTag class="angle"><?=$param1?>°</customTag>.
                    </p>
                    <p>
                        How much is the
