...
<body>
    <div class="mathcontainer" id="math">
        <h1 class="heading1">Height Of Flight</h1>
        <h2 class="heading2">
        ...
        <div class="description" id="description">
            <p>
                ...
                <customTag class="angle">45°</customTag>
                in order to reach a
                <customTag class="maxHeight">maximum height</customTag> of
                <customTag class="maxHeight">20 <customTag class="unit">m</customTag>
                </customTag>
                .
                <br />
                What is the
                <customTag class="velocity">initial velocity</customTag>,
                <customTag class="maxRange">horizontal range</customTag> and
                <customTag class="flight_time">flight time</customTag>
                of the object?
            </p>
        </div>
    </div>
    ...
    <script src="Type3/gravity and velocity 3.js"></script>
</body>
...
if ($param0val) {
    ...
    $sql = "INSERT INTO problem (user_id, problem_name, param1, param2, param3, param4) VALUES ($u_id,'projectile_page_3.php', $param1val, $param2val, $param3val, $param4val)";
