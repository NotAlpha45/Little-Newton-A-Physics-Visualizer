...
<head>
    ...
    <title>Gravity and velocity 4</title>
...
<body>
    <div class="mathcontainer" id="math">
        <h1 class="heading1">Range And Flight Unite</h1>
        <h2 class="heading2">
        ...
        <!-- <h2 class="heading">Known Horizontal Range And Known Maximum Height</h2> -->
        <div class="description" id="description">
            <p>
                ...
                <customTag class="maxRange">30 <customTag class="unit">m</customTag>
                </customTag>
                . <br />
    ...
    <script src="Type4/gravity and velocity 4.js"></script>
</body>
...
if ($param0val) {
    ...
    $sql = "INSERT INTO problem (user_id, problem_name, param1, param2, param3, param4) VALUES ($u_id,'projectile_page_4.php', $param1val, $param2val, $param3val, $param4val)";
