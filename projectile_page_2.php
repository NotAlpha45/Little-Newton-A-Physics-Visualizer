...
<main id="main">
            ...
            <div class="mathcontainer" id="math">
                ...
                <div class="description" id="description">
                    <p>
                        ...
                        <customTag class="angle"><?=$param1?>°</customTag> in order to reach a
    ...
    if ($param0val) {
        ...
        $sql = "INSERT INTO problem (user_id, problem_name, problem_link, param1, param2, param3, param4) VALUES ($u_id,'Range Is Key','$validUrl', $param1val, $param2val, $param3val, $param4val)";
